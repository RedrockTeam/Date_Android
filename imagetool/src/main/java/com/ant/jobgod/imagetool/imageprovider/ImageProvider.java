...
import com.ant.jobgod.imagetool.imageprovider.net.NetImageSearchActivity;
...
public class ImageProvider {
    ...
    public void getImageFromAlbum(OnImageSelectListener<ImageElement> mListener){
    ...
    public void getImageFromCamera(OnImageSelectListener<ImageElement> mListener){
        this.mListener = mListener;
    ...
    public void getImageFromNet(Searcher Searcher,OnImageSelectListener<ImageElement> mListener){
        this.mListener = mListener;
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent data){
        ...
        switch (requestCode){
            case REQUEST_CAMERA:
                mListener.onImageSelect(new ImageElement(){

                    @Override
                    public Uri getSmallImage() {
                        return Uri.fromFile(new File(tempImagePath));
                    }
            ...
            case REQUEST_NET:
                ...
                mListener.onImageSelect(new ImageElement() {
                    @Override
                    public Uri getSmallImage() {
                        return Uri.parse(netImage.getThumbImg());
                    }

                    @Override
                    public Uri getLargeImage() {
                        return Uri.parse(netImage.getLargeImg());
                    }
                });
                break;
        }
